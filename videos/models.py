...
class VideoComment(models.Model):
    comment    = models.ForeignKey('comments.Comment', on_delete=models.CASCADE, related_name='video_links')
    video      = models.ForeignKey(Video, on_delete=models.CASCADE, related_name='comment_links')
